...
export default function ExchangePage() {
    ...
    useEffect(() => {
        const unsubscribe = auth.onAuthStateChanged((user: any) => {
            if (user) {
                ...
                router.push("/login"); // Use router.push equivalent
            }
        });
    ...
    const handleExchange = async () => {
        ...
        setIsLoading(true);
        try {
            // Calculate 70% of the exchange amount
            const transferAmount = amount * 0.70;
            ...
            setExchangeAmount("");
            showToast(`Successfully exchanged ${amount} Coins`, 'success');
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white overflow-hidden relative">
            ...
            <div className="sticky top-0 z-50 bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-white/5 px-6 py-4 flex items-center gap-4">
                ...
                <h2 className="text-xl font-black text-white tracking-wide">Exchange Coins</h2>
            </div>
            ...
            <div className="p-6 space-y-8 max-w-lg mx-auto pt-10">
                ...
                <div className="p-8 rounded-[2.5rem] bg-[#131313] border border-white/5 relative overflow-hidden group hover:border-purple-500/20 transition-all duration-500">
                    ...
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mb-4">Available Coins</p>
                    <div className="flex justify-between items-end">
                        <div>
                            <h3 className="text-5xl font-black text-white tracking-tighter">
                                {userData?.inviteWallet?.toFixed(0) || "0"}
                            </h3>
                            <span className="text-purple-400 font-bold text-sm uppercase tracking-wider mt-1 block">Coins from Invites</span>
                        </div>
                ...
                <div className="relative">
                    <label className="block text-gray-500 text-xs font-bold uppercase tracking-widest mb-3 pl-2">Amount to Exchange</label>
                    <div className="relative">
                        <input
                            type="number"
            ...
            {showConfirmation && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/80 backdrop-blur-sm animate-fade-in">
                    <div className="w-full max-w-sm bg-[#1a1a1a] rounded-[2rem] border border-white/10 p-8 shadow-2xl relative overflow-hidden">
                        ...
                        <h3 className="text-2xl font-black text-white mb-2 text-center">Confirm Exchange</h3>
                        <p className="text-gray-400 text-center text-sm mb-8">Are you sure you want to proceed?</p>

                        <div className="space-y-4 mb-8">
                            <div className="flex justify-between items-center p-4 rounded-xl bg-white/5">
                                <span className="text-gray-400 text-sm">Exchange Amount</span>
                                <span className="text-white font-bold">{exchangeAmount} Coins</span>
                            </div>
                            <div className="flex justify-between items-center p-4 rounded-xl bg-white/5">
